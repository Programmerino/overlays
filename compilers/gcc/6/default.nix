...
let majorVersion = "6";
    ...
    patches =
      [ <nixpkgs/pkgs/development/compilers/gcc/use-source-date-epoch.patch> ]
      ...
      ++ optional (targetPlatform.libc == "musl") <nixpkgs/pkgs/development/compilers/gcc/libgomp-dont-force-initial-exec.patch>
